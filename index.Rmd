...
Je ne souhaite pas entrer dans le détail de mon analyse car ce document est adressé à un grand public. Si vous voulez en savoir plus, le code R est disponible en cliquant sur les "Show" ci-dessus.
...
Concentrons nous désormais sur les clusters de petites ammonites : <span style="color: #875692;">cl2</span>, <span style="color: #a1caf1;">cl4</span> et <span style="color: #006400;">cl5</span>. Il est intéressant de remarquer, que ces petites ammonites présentent le même "motif" que les grandes : les plus évolutes sont situés à gauche, les plus involutes à droite. Il est à noter que le cl5 se distingue par une épaisseur inhabituelle comme le montre le graphique ci-dessous: 
